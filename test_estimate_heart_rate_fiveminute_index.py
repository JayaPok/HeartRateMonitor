from heart_rate_monitoring import heart_rate_indicies_Plethysmograph,\
    estimate_heart_rate_fiveminute_index
...
def test_estimate_heart_rate_fiveminute_index():
    ...
    :returns: assertion of the last instantaneous five minute heart rate
     value of estimate_heart_rate_fiveminute_index() method
    ...
    one_minute_total_HR_Pleth = estimate_heart_rate_fiveminute_index(
        instantaneous_HR_indicies_Pleth, Fs)
